...
def multiple_linear_regression_ensemble(df, df_longest, df_2019_09_08, df_widest, results, target_mean, target_std,
    ...
    if multiple_linear_regression_ensemble_on:
        ...
        # save
        prediction_results.to_csv('/home/chrei/code/quantifiedSelfData/prediction_results.csv')  # save to file
...
def multiple_regression(df, results, dataset_name, prediction_results, regularization_strength, l1_ratio,
    ...
    for train_index, test_index in tscv.split(X):
        ...
        if i == 5:  # CV in time series neglects too much training data, thus use a simple train test split
            ...
            predictions = out_of_bound_correction(predictions, target_bounds_normalized)
